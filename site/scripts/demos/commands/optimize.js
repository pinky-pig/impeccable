  ...
  before: `
    <div style="width: 100%; max-width: 260px; display: flex; flex-direction: column; gap: 8px;">
      <div style="padding: 12px; background: #f5f5f5; border-radius: 6px;">
        <div style="font-size: 11px; color: #999; margin-bottom: 4px;">包体积</div>
      ...
      <div style="padding: 12px; background: #f5f5f5; border-radius: 6px;">
        <div style="font-size: 11px; color: #999; margin-bottom: 4px;">渲染时间</div>
        <div style="height: 8px; background: #e0e0e0; border-radius: 4px; overflow: hidden;">
      ...
      <div style="padding: 12px; background: #f5f5f5; border-radius: 6px;">
        <div style="font-size: 11px; color: #999; margin-bottom: 4px;">布局偏移</div>
        <div style="height: 8px; background: #e0e0e0; border-radius: 4px; overflow: hidden;">
  ...
  after: `
    <div style="width: 100%; max-width: 260px; display: flex; flex-direction: column; gap: 8px;">
      <div style="padding: 12px; background: var(--color-paper); border: 1px solid var(--color-mist); border-radius: 6px;">
        <div style="font-size: 11px; color: var(--color-ash); margin-bottom: 4px;">包体积</div>
      ...
      <div style="padding: 12px; background: var(--color-paper); border: 1px solid var(--color-mist); border-radius: 6px;">
        <div style="font-size: 11px; color: var(--color-ash); margin-bottom: 4px;">渲染时间</div>
        <div style="height: 8px; background: var(--color-mist); border-radius: 4px; overflow: hidden;">
      ...
      <div style="padding: 12px; background: var(--color-paper); border: 1px solid var(--color-mist); border-radius: 6px;">
        <div style="font-size: 11px; color: var(--color-ash); margin-bottom: 4px;">布局偏移</div>
        <div style="height: 8px; background: var(--color-mist); border-radius: 4px; overflow: hidden;">
